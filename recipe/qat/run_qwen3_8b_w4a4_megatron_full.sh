#!/usr/bin/env bash
# 8B Qwen3 Dense - Megatron W4A4 QAT, full
set -xeuo pipefail
...
# QAT Configuration — W4A4 (full, attention untouched)
qat_enable=True
qat_mode=w4a4
...
# full: ignore lm_head + router (no-op on dense 8B) + entire attention block.
